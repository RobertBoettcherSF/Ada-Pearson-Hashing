...
package Pearson_Hash is
   -- Custom type for the 256-entry Permutation Table indexed by Unsigned_8
   type Permutation_Table is array (Unsigned_8) of Unsigned_8;

   -- Standard RFC 3074 permutation table (a proper pseudo-random permutation of 0..255)
